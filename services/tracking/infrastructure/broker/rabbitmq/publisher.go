...
func (p *Publisher) Publish(ctx context.Context, cmd sharedModel.SendNotificationCommand) error {
	...
	if err := ch.PublishWithContext(ctx, "", rabbitmq3.QueueNotifications, false, false, amqp.Publishing{
...
func (p *Publisher) declareQueue() error {
	...
	if _, err = ch.QueueDeclare(rabbitmq3.QueueNotifications, true, false, false, false, nil); err != nil {
