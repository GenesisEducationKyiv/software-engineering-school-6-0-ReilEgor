...
func (p *Publisher) Publish(ctx context.Context, cmd contracts.SendNotificationCommand) error {
	...
	if err := ch.PublishWithContext(ctx, "", contracts.QueueNotifications, false, false, amqp.Publishing{
...
func (p *Publisher) declareQueue() error {
	...
	if _, err = ch.QueueDeclare(contracts.QueueNotifications, true, false, false, false, nil); err != nil {
