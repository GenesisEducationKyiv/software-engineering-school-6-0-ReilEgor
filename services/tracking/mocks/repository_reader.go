...
func (_m *RepositoryReader) GetAll(ctx context.Context) ([]model.Repository, error) {
	ret := _m.Called(ctx)
...
func (_m *RepositoryReader) GetByName(ctx context.Context, name string) (*model.Repository, error) {
