...
func (c *SubscriptionActivatedConsumer) consume(ctx context.Context) error {
	...
	if _, err = ch.QueueDeclare(rabbitmq.QueueSubscriptionActivated, true, false, false, false, nil); err != nil {
		return fmt.Errorf("declare queue: %w", err)
	}

	msgs, err := ch.Consume(rabbitmq.QueueSubscriptionActivated, "", false, false, false, false, nil)
	if err != nil {
